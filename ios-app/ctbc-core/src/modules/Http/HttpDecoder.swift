...
public typealias HttpDecoderConverter = ( _ path: [CodingKey], _ container: [String: Any] ) -> Any?

public class HttpDecoder: Decoder
{
	var converter: HttpDecoderConverter?
	var useThrow = false
	...
	public init( converter: HttpDecoderConverter? = nil )
	{
	...
	func copy( with value: Any ) -> HttpDecoder
	{
		let d = HttpDecoder()
		d.container = value
	...
	struct UnkeyDC: UnkeyedDecodingContainer
	{
		...
		init( decoder: HttpDecoder, container: [Any] )
		{
	...
	struct KeyDCP<Key: CodingKey>: KeyedDecodingContainerProtocol
	{
		...
		init( decoder: HttpDecoder, container: [String: Any] )
		{
			self.decoder = decoder
			self.container = container
		}
...
// for single value
extension HttpDecoder: SingleValueDecodingContainer
{
