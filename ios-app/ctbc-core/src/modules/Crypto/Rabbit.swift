public final class Rabbit: BlockCipher
{
	...
	fileprivate func setup()
	{
		...
		let k = Array<UInt32>( unsafeUninitializedCapacity: 8 )
		{ buf, count in
			for j in 0 ..< 8
			{
	...
	private func nextState()
	{
		...
		self.x = Array<UInt32>( unsafeUninitializedCapacity: 8 )
		{ newX, count in
...
extension Rabbit: Cipher
{
	public func encrypt( _ bytes: ArraySlice<UInt8> ) throws -> Array<UInt8>
	{
		...
		return Array<UInt8>( unsafeUninitializedCapacity: bytes.count )
		{ result, count in
